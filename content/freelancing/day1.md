...
# 2	[[freelancing|Freelancing]] by [[people/iti/Pola Adel|Pola Adel]]
Trust is the most important commodity when freelancing

Very challenges because it is truely an open market
you need very spread out experience.

## 2.1	upwork
controlled: 1 profile per freelancer
brand: promotes remote quality freelancers and doesn't promote low price
enterprice: more exposure to international companies and brands

to make sure you have the most appropriate category and skills required for work you need. create a client account and simiulate a client requesting a certain job and see the automatic skills and category that upwork presents.

take the skills it presents into an external note and apply them into chatgpt to make into a profile description and put them in your profile.

One of the most importna things when applying for jobs is the cover letter. It can be the difference between a client interview and nothing.
## 2.2	toptal
similar to upwork but requires you pass 1 hr interview and 3 technical interviews

## 2.3	[[skills|Skills]] 
## 2.4	Categorization of freelancers
### 2.4.1	Rising Talent
### 2.4.2	Top Rated
### 2.4.3	Top Rated Plus

## 2.5	tips for choosing work as beginner
- new client
- limited budget
- rush client
- after 12 AM
- be available 24/7 keep phone on

## 2.6	tips for posting cover letter
- use [loom](https://www.loom.com/) to send a screen recording of your previous work
- say something relevant
- add attachment proof of work relating to task
- call to action/question/suggestion
- write 1 or 2 lines about your expertise
## 2.7	interview
- be friendy
- be professional
- focus on helping the delivering real value
